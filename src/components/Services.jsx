...
const SERVICES = [
  {
    ...
    bullets: [
      'Virtual Front Desk | Patient Scheduling | EHR Update',
      'Insurance Verification | Prior Authorizations | Billing Support',
      'Inbound Patient Queues | Care Coordination | HIPAA Compliance',
    ],
    delay: '',
  },
  {
